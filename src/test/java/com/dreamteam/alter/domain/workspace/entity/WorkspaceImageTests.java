...
class WorkspaceImageTests {

    @Test
    @DisplayName("정상 sortOrder로 생성된다")
    void create_validSortOrder_createsSuccessfully() {
        // when
    ...
    void create_negativeSortOrder_throwsIllegalArgumentException() {
        // when & then
    ...
    void updateSortOrder_validValue_updatesSuccessfully() {
        // given
        WorkspaceImage image = WorkspaceImage.create(null, "file-1", 0);
    ...
    void updateSortOrder_negativeValue_throwsIllegalArgumentException() {
        // given
        WorkspaceImage image = WorkspaceImage.create(null, "file-1", 0);
