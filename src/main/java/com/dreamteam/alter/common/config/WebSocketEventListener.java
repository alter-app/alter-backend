...
public class WebSocketEventListener {
    ...
    public void onConnected(SessionConnectedEvent event) {
        resolve(event.getUser())
            .ifPresent(principal -> chatPresenceStore.markOnline(principal.scope(), principal.memberId()));
    }

    @EventListener
    public void onDisconnect(SessionDisconnectEvent event) {
        resolve(event.getUser())
            .ifPresent(principal -> chatPresenceStore.markOffline(principal.scope(), principal.memberId()));
    }
