...
@Schema(description = "받은 대타 요청 응답")
public class ReceivedSubstituteRequestResponseDto {
    ...
    public static ReceivedSubstituteRequestResponseDto of(ReceivedSubstituteRequestListResponse response) {
        return ReceivedSubstituteRequestResponseDto.builder()
            .id(response.getId())
