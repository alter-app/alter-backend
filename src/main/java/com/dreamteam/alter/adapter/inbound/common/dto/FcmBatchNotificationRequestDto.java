...
public class FcmBatchNotificationRequestDto {
    ...
    public static FcmBatchNotificationRequestDto of(List<Long> targetUserIds, String title, String body) {
        return new FcmBatchNotificationRequestDto(targetUserIds, title, body);
    }
}
