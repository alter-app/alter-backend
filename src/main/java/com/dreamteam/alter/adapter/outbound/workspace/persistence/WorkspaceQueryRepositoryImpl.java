...
public class WorkspaceQueryRepositoryImpl implements WorkspaceQueryRepository {
    ...
    public List<ManagerWorkspaceListResponse> getManagerWorkspaceList(ManagerUser managerUser) {
        ...
        return queryFactory
            .select(Projections.constructor(
                ...
                qWorkspace.businessType.name,
                qWorkspace.businessTypeDetail,
    ...
    @Override
    public List<Workspace> findAllForNextMonthShiftGeneration(int day, boolean isLastDayOfMonth) {
        QWorkspace qWorkspace = QWorkspace.workspace;
        ...
        return queryFactory
            ...
            .where(
                isLastDayOfMonth
                    ? qWorkspace.nextMonthShiftGenDay.goe(day)
