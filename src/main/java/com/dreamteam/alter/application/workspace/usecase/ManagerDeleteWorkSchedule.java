...
import com.dreamteam.alter.domain.workspace.port.inbound.ManagerDeleteScheduleUseCase;
...
@Service("managerDeleteWorkSchedule")
@RequiredArgsConstructor
@Transactional
public class ManagerDeleteWorkSchedule implements ManagerDeleteScheduleUseCase {
