...
public class GetMyJoinRequestList implements GetMyJoinRequestListUseCase {
    ...
    @Override
    public CursorPaginatedApiResponse<MyJoinRequestResponseDto> execute(AppActor actor, BusinessJoinRequestStatus status, LocalDate from, LocalDate to, CursorPageRequestDto cursorPageRequest) {
